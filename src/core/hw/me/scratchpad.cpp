...
/* core/hw/me/scratchpad.cpp - MediaEngine scratchpad */
...
namespace kanacore::hw::me::scratchpad {

using namespace common;

constexpr u64 SCRATCHPAD_ADDR = 0x00000000;
constexpr u64 SCRATCHPAD_SIZE = 0x200000;
...
void hard_reset() {
    ...
    kanacore::get_me_bus_ptr()->map(SCRATCHPAD_ADDR, SCRATCHPAD_SIZE, page_desc);
}
